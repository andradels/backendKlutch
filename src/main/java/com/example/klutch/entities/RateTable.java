...
public class RateTable implements Serializable {
	...
	@ManyToMany
	@JoinTable(name = "tb_rate_installment",
			joinColumns = @JoinColumn(name = "rate_table_id"),
	...
	public RateTable(Long id, String name) {
		super();
		this.id = id;
		this.name = name;
	}
